			...
			<div class="gallery_box entry-content">
				...
				<?php 
					...
					if ( 1 == $gllrprfssnl_options['border_images'] ) {
						$gllrprfssnl_border = 'border-width: ' . $gllrprfssnl_options['border_images_width'] . 'px; border-color:' . $gllrprfssnl_options['border_images_color'] . '; padding:0;';
						$gllrprfssnl_border_images = $gllrprfssnl_options['border_images_width'] * 2;
					} else {
						$gllrprfssnl_border = 'padding:0;';
						$gllrprfssnl_border_images = 0;
					}
					$count++;
				?>
					<li>
						<img style="width:<?php echo $gllrprfssnl_options['gllrprfssnl_custom_size_px'][0][0]; ?>px; <?php echo $gllrprfssnl_border; ?>" alt="<?php echo $post->post_title; ?>" title="<?php echo $post->post_title; ?>" src="<?php echo $image_attributes[0]; ?>" />
						<div class="gallery_detail_box">
							<div><?php echo $post->post_title; ?></div>
							<div><?php echo the_excerpt_max_charlength(100); ?></div>
							<a href="<?php echo $permalink; echo basename( get_permalink( $post->ID ) ); ?>"><?php echo $gllrprfssnl_options["read_more_link_text"]; ?></a>
						</div>
						<div class="clear"></div>
					</li>
